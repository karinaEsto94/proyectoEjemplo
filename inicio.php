                                            ...
                                            <form class="form-horizontal"> 
                                              <fieldset>
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <span class="help-block">Ejemplo: Ricardo Rodriguez Gallegos</span>  
                                                  </div>
                                                </div>
                                                <div class="form-group">
                                                  <label class="col-md-4 control-label" for="textinput">CURP:</label>  
                                                  <div class="col-md-4">
                                                  <input id="textinput" name="textinput" type="text" placeholder="Curp" class="form-control input-md" required>
                                            ...
                                            <fieldset>
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class='input-group date col-md-4' id='datetimepicker1'>
                                                  <input type='text' name="fecharecepcion" class="form-control" required/>
                                                  <span class="input-group-addon">
                                                      <span class="glyphicon glyphicon-calendar"></span>
                                                  </span>
                                                </div>                                          
                                                <p class="help-block">Ejemplo: 2010-02-01 00:00</p> 
                                              </div>
                                              <div class="form-group">
                                                ...
                                                <div class='input-group date col-md-4' id='datetimepicker2'>
                                                  <input type='text' name="fechainicio" class="form-control" required/>
                                                  <span class="input-group-addon">
                                                      <span class="glyphicon glyphicon-calendar"></span>
                                                  </span>
                                                </div>                                          
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class='input-group date col-md-4' id='datetimepicker3'>
                                                  <input type='text' name="fechafinalizacion" class="form-control" required/>
                                                  <span class="input-group-addon">
                                                      <span class="glyphicon glyphicon-calendar"></span>
                                                  </span>
                                                </div>                                          
